...
class ApiApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_headline = _Endpoint(
            settings={
        ...
        self.create_reportitem = _Endpoint(
            settings={
        ...
        self.list_notestatus = _Endpoint(
            settings={
        ...
        self.list_reportitems = _Endpoint(
            settings={
                'response_type': ([Reportitem],),
                'auth': [
                    'basicAuth',
        ...
        self.partial_update_headline = _Endpoint(
            settings={
                'response_type': (Headline,),
                'auth': [
                    'basicAuth',
            ...
            api_client=api_client,
            callable=__partial_update_headline
        )
        ...
        self.partial_update_note = _Endpoint(
            settings={
                'response_type': (Note,),
                'auth': [
                    'basicAuth',
            ...
            api_client=api_client,
            callable=__partial_update_note
        )
        ...
        def __partial_update_reportitem(
            self,
            reportitem_id,
            **kwargs
        ):
        ...
        self.partial_update_reportitem = _Endpoint(
            settings={
                'response_type': (Reportitem,),
                'auth': [
                    'basicAuth',
            ...
            api_client=api_client,
            callable=__partial_update_reportitem
        )
        ...
        self.retrieve_headline = _Endpoint(
            settings={
                'response_type': (Headline,),
                'auth': [
                    'basicAuth',
        ...
        self.retrieve_note = _Endpoint(
            ...
            api_client=api_client,
            callable=__retrieve_note
        )

        def __retrieve_notestatus(
            self,
            notestatus_id,
            **kwargs
        ):
        ...
        self.retrieve_notestatus = _Endpoint(
            settings={
                'response_type': (Notestatus,),
                'auth': [
                    'basicAuth',
            ...
            api_client=api_client,
            callable=__retrieve_notestatus
        )
        ...
        self.retrieve_reportitem = _Endpoint(
            settings={
                'response_type': (Reportitem,),
                'auth': [
                    'basicAuth',
            ...
            api_client=api_client,
            callable=__retrieve_reportitem
        )
        ...
        self.update_headline = _Endpoint(
            settings={
                'response_type': (Headline,),
                'auth': [
                    'basicAuth',
        ...
        self.update_reportitem = _Endpoint(
            settings={
                'response_type': (Reportitem,),
                'auth': [
                    'basicAuth',
